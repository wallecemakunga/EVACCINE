...
<body>
  ...
  <nav class="navbar">
    <div class="logo_item">
      ...
      <span class="logo_name">Patient<br>ID: <?php echo $_SESSION['username']; ?> </span>
    </div>
    ...
    <!-- sidebar -->
     <nav class="sidebar">
      <div class="menu_content">
        <ul class="menu_items">
         <li class="item">
            <a href="vaccine_result.php" class="nav_link">
          ...
          <li class="item">
            ...
            <ul class="menu_items submenu">
              <a href="booking.php" class="nav_link sublink">
                <span class="navlink_icon">
             ...
             <a href="results.php" class="nav_link sublink">
              <span class="navlink_icon">
                <i class='bx bxs-message-rounded-check'></i></span>
        ...
        <ul class="menu_items">
          ...
          <li class="item">
            <a href="Vaccination.php" class="nav_link">
              <span class="navlink_icon">
                <i class="bx bxs-injection"></i>
              </span>
              <span class="navlink">Vaccination</span>
            </a>
          </li>
